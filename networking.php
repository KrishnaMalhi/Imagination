...
<body>
  <div class="wrapper">
    ...
    <section class="page-title page-title-layout9 bg-overlay bg-parallax">
      <div class="bg-img"><img src="assets/images/page-titles/nn.jpg" alt="background"></div>
      <div class="container">
        <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
            <h1 class="pagetitle__heading">Networking Services</h1>
            <p class="pagetitle__desc">Trying to solve all your IT challenges internally can become costly and a major
              distraction, Leveraging knowledgeable IT consulting firms like ushelps your business remain secure.
            </p>
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
                        <div class="heading heading-layout2 text-center mb-50">
                            <h3 class="heading__title">Networking Development Services</h3>
                        </div><!-- /.heading -->
                    </div><!-- /.col-lg-8 -->
                </div><!-- /.row -->
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/services/2.png" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Intercom Services
                            </h4>
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            ...
                            <h4 class="service-item__title">Access Points </h4>
                            <p class="service-item__desc">
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/services/server.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Server Installation & Maintenance
