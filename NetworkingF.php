...
<body>
    ...
    =========================== -->
        <section class="page-title page-title-layout9 bg-overlay bg-parallax">
            <div class="bg-img"><img src="assets/images/page-titles/n10.jpg" alt="background"></div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <h1 class="pagetitle__heading">Networking</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/mtk.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Mikrotik
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/ms1.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Motorola
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/cn2.jpeg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Cambium Networks
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/toto.webp" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Totolink
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/Mkrouter.webp" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Mikrotik
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/Mrouter.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Motorola
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/cnN.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Cambium Networks 
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/fiber.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Western Digital
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/as1.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Mikrotik
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/as3.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Mikrotik
