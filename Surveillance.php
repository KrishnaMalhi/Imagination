            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12 col-xl-6">
                        <h1 class="pagetitle__heading">Surveillance</h1>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/camera.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Dahua
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/camera2.png" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">HIKVISION
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/wd.webp" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                    ...
                    <div class="col-sm-12 col-md-4 col-lg-4">
                        <div class="service-item">
                            <div class="service-item__img">
                                <img src="assets/images/page-titles/seagate.jpg" alt="service" class="w-100">
                            </div><!-- /.service-item__img -->
                            <h4 class="service-item__title">Seagate
